...
Public surface
--------------
analyze_plasma(input)            async function — direct callable
ANALYZE_PLASMA_TOOL              pydantic_ai.Tool wrapper (None if pydantic_ai
                                 not installed; KhoriumAgents pins it)
