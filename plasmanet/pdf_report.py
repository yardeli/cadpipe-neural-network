...
# Re-export the canonical trajectory grid so callers that historically did
# `from plasmanet.pdf_report import CANONICAL_RAMC_POINTS, find_canonical_match`
# keep working. Single source of truth lives in plasmanet/ram_c_trajectory.py.
from .ram_c_trajectory import (    # noqa: E402  (kept here for back-compat re-export)
