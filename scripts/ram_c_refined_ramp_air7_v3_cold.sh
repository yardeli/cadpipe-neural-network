...
% Bulk-flow residual (RMS_DENSITY_0 = electrons = trivially low)
...
run_stage() {
    ...
    local restart=$3
    local prev_dir=$4
    local stage_dir="${RUNS}/ramC_refined_air7v3_M${mach/./_}_A61"
    mkdir -p "$stage_dir"
...
run_stage 15.0 1500 YES "${RUNS}/ramC_refined_air7v3_M10_0_A61"
run_stage 18.0 1500 YES "${RUNS}/ramC_refined_air7v3_M15_0_A61"
run_stage 22.5 3000 YES "${RUNS}/ramC_refined_air7v3_M18_0_A61"

echo "======================================================"
echo "  AIR-7 v3 (cold-start) refined-mesh ramp complete."
echo "  M22.5 flow.vtu at:"
echo "    ${RUNS}/ramC_refined_air7v3_M22_5_A61/flow.vtu"
echo "======================================================"
